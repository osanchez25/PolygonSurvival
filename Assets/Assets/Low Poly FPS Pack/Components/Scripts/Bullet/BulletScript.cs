...
public class BulletScript : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision) 
	{
		...
		if (collision.transform.tag == "Blood") 
		{
			...
			if (collision.gameObject.layer == LayerMask.NameToLayer("Enemy") || collision.gameObject.layer == LayerMask.NameToLayer("Head"))
			{
			...
			if (collision.gameObject.layer == LayerMask.NameToLayer("Foto"))
			{
				GameObject.Find("SpawnManager").GetComponent<SpawnManager>().UpdateWaveEnemies(20);
